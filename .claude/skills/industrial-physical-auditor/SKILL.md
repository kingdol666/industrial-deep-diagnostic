...
Read "<this-skill-directory>/references/agent-protocol.md" and execute the pre-report physical audit.
...
Read "<this-skill-directory>/references/agent-protocol.md" and execute the final physical audit.
