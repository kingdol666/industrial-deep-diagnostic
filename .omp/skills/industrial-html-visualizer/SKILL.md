...
SKILL_PATH=<this-skill-directory>/../../../.claude/skills/industrial-html-visualizer
OUTPUT_HTML=<run-dir-path>/diagnostic-report.html
AUDIENCE=mixed
VISUAL_MODE=story

Read "<this-skill-directory>/../../../.claude/skills/industrial-html-visualizer/references/agent-protocol.md" and execute the complete protocol.
