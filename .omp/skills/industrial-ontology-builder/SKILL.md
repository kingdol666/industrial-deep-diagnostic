...
SKILL_PATH=<this-skill-directory>/../../../.claude/skills/industrial-ontology-builder
INTERACTION_MODE=auto

Read "<this-skill-directory>/../../../.claude/skills/industrial-ontology-builder/references/agent-protocol.md" and execute the complete protocol.
