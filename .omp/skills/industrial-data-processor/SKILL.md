...
SKILL_PATH=<this-skill-directory>/../../../.claude/skills/industrial-data-processor

Read "<this-skill-directory>/../../../.claude/skills/industrial-data-processor/references/agent-protocol.md" and execute Phase 0-6.
...
- Python venv: "<this-skill-directory>/../../../.claude/skills/industrial-data-processor/scripts/.venv/bin/python" (run uv_env_setup.mjs first if missing)
