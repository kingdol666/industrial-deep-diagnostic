...
SKILL_PATH=<this-skill-directory>/../../../.claude/skills/industrial-vlm-analyzer

Read "<this-skill-directory>/../../../.claude/skills/industrial-vlm-analyzer/references/agent-protocol.md" and execute the complete protocol.
