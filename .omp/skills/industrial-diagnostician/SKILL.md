...
SKILL_PATH=<this-skill-directory>/../../../.claude/skills/industrial-diagnostician
${REPAIR_INSTRUCTIONS ? 'REPAIR_INSTRUCTIONS=' + REPAIR_INSTRUCTIONS : ''}

Read "<this-skill-directory>/../../../.claude/skills/industrial-diagnostician/references/agent-protocol.md" and execute Phase 0-7.
