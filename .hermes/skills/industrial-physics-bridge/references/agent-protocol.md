...
2. **Run the script.** Execute `uv run --project .claude/shared/scripts python .claude/skills/industrial-physics-bridge/scripts/physics_bridge_builder.py --run-dir <RUN_DIR>`.
