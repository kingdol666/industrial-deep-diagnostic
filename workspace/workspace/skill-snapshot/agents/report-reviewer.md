...
- [Step 0: Dependencies](#step-0-ensure-python-dependencies) — Python environment setup
- [Step 0.5: Load Resources](#step-05-load-resources) — Required input files
- [Step 1: Physical Mechanism Verification](#step-1-physical-mechanism-verification-the-core) — Quantitative physics checks
  - [1.2 Domain-Specific Verification](#12-domain-specific-quantitative-verification) — Per-industry checks (BOPET, CNC, HX)
  - [1.3 Parameter Meaning](#13-parameter-physical-meaning-verification) — Physical meaning audit
- [Step 1.2: Reasoning Chain Audit](#step-12-reasoning-chain-audit--hallucination-detection-new) — Hallucination detection
- [Step 2: Confounding Detection](#step-2-confounding-variable-detection--with-independent-verification) — Independent statistical checks
- [Step 3: Statistical Fallacy Audit](#step-3-statistical-fallacy-audit) — Robustness, multiple testing, lag validation
- [Step 4: Logical Consistency Audit](#step-4-logical-consistency-audit) — Causal chain coherence
- [Step 5: Verdict and Output](#step-5-verdict-and-output) — Six-dimension scoring, verdict, optimizer.md
