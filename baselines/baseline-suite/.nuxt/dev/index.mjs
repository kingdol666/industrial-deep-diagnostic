...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import fs, { promises } from 'node:fs';
import net from 'node:net';
import { fileURLToPath } from 'node:url';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/devalue/index.js';
import { isVNode, isRef, toValue } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/unstorage/drivers/fs.mjs';
import file_58_47_47_47D_58_47codes_47myskills_47industrial_45deep_45diagnostic_47baselines_47baseline_45suite_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js';
import { digest, hash as hash$1 } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/youch-core/build/index.js';
import { Youch } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/errx/dist/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', file_58_47_47_47D_58_47codes_47myskills_47industrial_45deep_45diagnostic_47baselines_47baseline_45suite_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"file:///D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite/.data/kv"}));
...
const rootDir = "D:/codes/myskills/industrial-deep-diagnostic/baselines/baseline-suite";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[],"noscript":[],"title":"IDD Baseline Suite"};
...
const _nYFEifQQZxHaAYuLsgrVY4tpsGOOB79G__Pzhjmr80 = (nitroApp) => {
...
const plugins = [
  _nYFEifQQZxHaAYuLsgrVY4tpsGOOB79G__Pzhjmr80,
...
const _uXaxkd = eventHandler((event) => {
...
const _lazy_qWDrSd = () => Promise.resolve().then(function () { return _caseId__post$1; });
const _lazy_z79sai = () => Promise.resolve().then(function () { return scenarios_get$1; });
const _lazy_BRYGRc = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _uXaxkd, lazy: false, middleware: true, method: undefined },
  { route: '/api/diagnose/:caseId', handler: _lazy_qWDrSd, lazy: true, middleware: false, method: "post" },
  { route: '/api/scenarios', handler: _lazy_z79sai, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_BRYGRc, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_BRYGRc, lazy: true, middleware: false, method: undefined }
];
...
const SUITE_ROOT = path.resolve(path.dirname(fileURLToPath(globalThis._importMeta_.url)), '..', '..');
const REPO = path.resolve(SUITE_ROOT, '..', '..');

/** Truth-free routing facts per scenario. */
function scenarioRouting() {
...
function pcaModel(train, cutoff = VAR_CUTOFF) {
...
function buildExplainRoot(top6, detected) {
...
function validateEndpointBaseUrl(rawUrl) {
  let u;
...
// ---------- prompts ----------
function buildBlindPrompt(brief, regime, causeTable) {
...
// ---------- execution ----------
async function runLlmArm({ caseId, brief, regime, causeTable, prompt }) {
...
const _caseId__post = defineEventHandler(async (event) => {
...
const _caseId__post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: _caseId__post
}, Symbol.toStringTag, { value: 'Module' }));

// GET /api/scenarios — the 12 benchmark scenarios (truth-free view from the blind briefs)

const scenarios_get = defineEventHandler(() => {
...
const scenarios_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: scenarios_get
}, Symbol.toStringTag, { value: 'Module' }));
